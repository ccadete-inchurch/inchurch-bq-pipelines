...
from .base_classes import GrupoPipeline
...
class GrupoInchurchPipeline(GrupoPipeline):
    """Inchurch-specific grupo pipeline."""

    def executar(self, max_paginas: int):
        """
        Orquestra a execução do pipeline de grupos.
        """
        logger.info("🚀 Iniciando pipeline de grupos")
        ...
        df = self._processar_grupo_detalhado(dados_brutos)
        ...
        return self.carregar_para_postgres(
            ...
            script_rodado="Pipeline de grupos Inchurch"
        )


main_grupo = create_main_pipeline(
    GrupoInchurchPipeline,
    class_name="grupos Inchurch",
    max_paginas=150,
    system="inchurch"
)
